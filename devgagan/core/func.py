   ...
   if update_channel:
      try:
         ...
         if user.status == "kicked":
            await message.reply_text("Sorry Sir, You are Banned. Contact -- @BinaryBandiT69")
            return 1
         ...
         await message.reply_text("Something Went Wrong. Contact us @BinaryBandiT69...")
         return 1
...
**__Speed__** : {3}/s
**__Time__** : {4}\n\n
**__Powered by [TBots_Father](https://t.me/BinaryBandiT69)__**
"""
